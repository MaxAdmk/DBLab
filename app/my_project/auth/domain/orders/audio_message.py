...
class AudioMessage(db.Model, IDto):
    """
    ...
    def __repr__(self) -> str:
        return f"AudioMessage({self.id}, '{self.arrival_time}', '{self.sender}', ''{self.text_chat_name})"
    ...
    @staticmethod
    def create_from_dto(dto_dict: Dict[str, Any]) -> AudioMessage:
        """
